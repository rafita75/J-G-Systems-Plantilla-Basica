// client/src/components/accounting/CustomerDebtModal.jsx
import { useState } from 'react';
import api from '../../services/api';
import Button from '../ui/Button';
import Input from '../ui/Input';

export default function CustomerDebtModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post('/accounting/customer-debt', formData);
      onSuccess();
      setFormData({ clienteNombre: '', clienteTelefono: '', monto: '', fechaLimite: '', notas: '' });
    } catch (err) {
